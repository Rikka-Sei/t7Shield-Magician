...
use magi_transport::cdb::{
    cdb_security_in, cdb_security_out, CMD_TIMEOUT, DISCOVERY_ALLOC_LEN, TCG_ALLOC_LEN,
};
use magi_transport::transport::{Direction, Transport, TransportError};
...
/// `magi_transport::sense::SenseData::is_unsupported_security_protocol`，本层只做分类。
///
...
mod tests {
    ...
    use magi_transport::cdb::DISCOVERY_SP_SPECIFIC;
    use magi_transport::sense::SenseData;
    use magi_transport::transport::{DeviceTarget, ScsiCdb};
